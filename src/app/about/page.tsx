...
export default function AboutPage() {
  return (
    <div className="bg-[rgb(var(--background))] min-h-screen text-[rgb(var(--foreground))] font-sans overflow-hidden transition-colors duration-300">
      
      {/* 1. Immersive Hero Banner */}
      <section className="relative py-24 flex items-center justify-center text-center overflow-hidden border-b border-white/5">
        ...
        <div className="relative max-w-3xl mx-auto px-4 space-y-5 z-10">
          ...
          <h1 className="font-serif text-4xl md:text-6xl tracking-widest text-[rgb(var(--foreground))] leading-tight">
            Crafting Extraordinary Light
          </h1>
          <p className="text-xs text-[rgb(var(--text-secondary))] tracking-widest leading-relaxed max-w-xl mx-auto">
            Where traditional artisanship meets architectural ambition — handcrafted for Australia's finest spaces.
          </p>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 space-y-28">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          <ScrollReveal variant="slideRight" className="space-y-6">
            ...
            <h2 className="font-serif text-3xl tracking-wide text-[rgb(var(--foreground))] leading-snug">
              A Response to Space and Form
            </h2>
            <p className="text-sm text-[rgb(var(--text-secondary))] tracking-wide leading-[2] font-light">
          ...
          <ScrollReveal variant="slideLeft" className="aspect-[4/3] bg-[rgb(var(--surface))] overflow-hidden border border-[rgb(var(--border))] relative">
            <img
              src="/about-us/about1.webp"
              alt="Artisanal glass detailing"
              className="w-full h-full object-cover object-right transition-transform duration-700 hover:scale-105"
            />
          </ScrollReveal>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <ScrollReveal variant="slideLeft" className="md:order-1 aspect-[4/3] bg-[rgb(var(--surface))] overflow-hidden border border-[rgb(var(--border))] relative">
            <img
        ...
        {/* 4. Core Pillars */}
        <section className="border-t border-[rgb(var(--border))] pt-20">
          <ScrollReveal variant="slideUp" className="text-center mb-16 max-w-xl mx-auto">
            ...
            <h2 className="font-serif text-3xl tracking-widest text-[rgb(var(--foreground))] mt-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <ScrollReveal key={pillar.title} variant="slideUp" delay={i * 0.1} className="space-y-5 p-8 bg-[rgb(var(--surface))] border border-[rgb(var(--border))] hover:border-[#C9A96E]/30 transition-colors duration-500 rounded-xl">
                {pillar.icon}
                <h3 className="font-serif text-lg text-[rgb(var(--foreground))] tracking-wide">{pillar.title}</h3>
                <p className="text-sm text-[rgb(var(--text-secondary))] tracking-wide leading-[1.9] font-light">{pillar.desc}</p>
              </ScrollReveal>
            ))}
          </div>
        </section>
        ...
        <section className="border-t border-[rgb(var(--border))] pt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <ScrollReveal key={item.step} variant="fade" delay={i * 0.1} className="p-7 bg-[rgb(var(--surface))] border border-[rgb(var(--border))] hover:border-[#C9A96E]/30 transition-colors duration-500 space-y-4 rounded-xl">
                <span className="text-2xl font-serif font-light text-[#C9A96E] block">{item.step}</span>
                <h4 className="font-serif text-sm text-[rgb(var(--foreground))] tracking-wide">{item.title}</h4>
                <p className="text-xs text-[rgb(var(--text-secondary))] tracking-wide leading-[1.9] font-light">{item.desc}</p>
              </ScrollReveal>
            ))}
          </div>
        </section>
        ...
        {/* 6. CTA Banner */}
        <section className="border-t border-[rgb(var(--border))] pt-20">
          <ScrollReveal variant="slideUp" className="relative bg-[rgb(var(--surface))] border border-[rgb(var(--border))] p-14 md:p-20 text-center overflow-hidden rounded-2xl">
            {/* Ambient glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-40 bg-[#C9A96E] rounded-full blur-[100px] opacity-10 pointer-events-none" />
            
            <span className="text-[9px] tracking-[0.4em] uppercase text-[#C9A96E] block mb-4">
              Explore Our Collection
            </span>
            <h2 className="font-serif text-3xl md:text-4xl text-[rgb(var(--foreground))] tracking-wide mb-6">
              Ready to Transform Your Space?
            </h2>
            <p className="text-sm text-[rgb(var(--text-secondary))] tracking-wide leading-relaxed max-w-md mx-auto mb-10">
