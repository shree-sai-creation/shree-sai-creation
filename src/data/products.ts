...
export const PRODUCTS: Product[] = [
  ...
  {
    id: "prod_7",
    name: "Luna Alabaster Globe Lamp",
    slug: "luna-alabaster-globe-lamp",
    description: "An elegant table lamp carved in a sphere of authentic natural alabaster. Sat on a weighted solid brass base plate, Luna shines a warm, organic glow, highlighting the natural mineral formations of the stone.",
